...
//    rt_event_init(&xMasterOsEvent,"master event",RT_IPC_FLAG_PRIO);
    master_event_Handle = xEventGroupCreateStatic(&xMasterOsEvent);/*创建事件组，成功返回句柄*/
    return TRUE;
}
...
//    rt_event_send(&xMasterOsEvent, eEvent);
    xEventGroupSetBits(master_event_Handle, eEvent);    /*设置事件标志组 eEvent 置1*/
    return TRUE;
}
...
//    rt_event_send(&xMasterOsEvent, EV_MASTER_ERROR_RESPOND_TIMEOUT);
    xEventGroupSetBits(master_event_Handle, EV_MASTER_ERROR_RESPOND_TIMEOUT);    /*设置事件标志组 EV_MASTER_ERROR_RESPOND_TIMEOUT 置1*/
...
//    rt_event_send(&xMasterOsEvent, EV_MASTER_ERROR_RECEIVE_DATA);
    xEventGroupSetBits(master_event_Handle, EV_MASTER_ERROR_RECEIVE_DATA);    /*设置事件标志组 EV_MASTER_ERROR_RECEIVE_DATA 置1*/
    /* You can add your code under here. */
...
//    rt_event_send(&xMasterOsEvent, EV_MASTER_ERROR_EXECUTE_FUNCTION);
    xEventGroupSetBits(master_event_Handle, EV_MASTER_ERROR_EXECUTE_FUNCTION);    /*设置事件标志组 EV_MASTER_ERROR_EXECUTE_FUNCTION 置1*/
    /* You can add your code under here. */
...
//    rt_event_send(&xMasterOsEvent, EV_MASTER_PROCESS_SUCESS);
      xEventGroupSetBits(master_event_Handle, EV_MASTER_PROCESS_SUCESS);    /*设置事件标志组 EV_MASTER_PROCESS_SUCESS 置1*/
    /* You can add your code under here. */
